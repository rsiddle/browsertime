...
module.exports.configureBuilder = function(builder, options) {
  ...
  /*
  ffOptions.setPreference('extensions.netmonitor.har.enableAutomation', true);
  ffOptions.setPreference('extensions.netmonitor.har.contentAPIToken', 'test');
  ffOptions.setPreference('extensions.netmonitor.har.autoConnect', true);
  ffOptions.setPreference(
    'devtools.netmonitor.har.includeResponseBodies',
    get(options, 'firefox.includeResponseBodies', false)
  );
  ffOptions.setPreference('xpinstall.signatures.required', false);
